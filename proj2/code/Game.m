classdef (Abstract) Game < handle
    ...
    methods      
        ...
        function r = cumulativeRewardBestActionHindsight(self)
            %   Returns the cumulative reward of the best fixed action in hindsight

            %%  the sum computes the cumulative reward for all the fixed actions; 
            %%  the max produces the maximum reward that corresponds to the best fixed action.  
